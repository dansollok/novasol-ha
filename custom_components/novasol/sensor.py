...
STATS_SENSORS: tuple[NovaSolSensorDescription, ...] = (
    ...
    NovaSolSensorDescription(
        key="annual_income_1y_ago",
        name="Income 1 year ago",
        native_unit_of_measurement="DKK",
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda d: d.get("annual_income_1y_ago"),
    ),
    NovaSolSensorDescription(
        key="annual_income_2y_ago",
        name="Income 2 years ago",
        native_unit_of_measurement="DKK",
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda d: d.get("annual_income_2y_ago"),
    ),
    NovaSolSensorDescription(
        key="annual_income_3y_ago",
        name="Income 3 years ago",
        native_unit_of_measurement="DKK",
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda d: d.get("annual_income_3y_ago"),
    ),
    NovaSolSensorDescription(
        key="annual_income_4y_ago",
        name="Income 4 years ago",
        native_unit_of_measurement="DKK",
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda d: d.get("annual_income_4y_ago"),
    ),
    NovaSolSensorDescription(
