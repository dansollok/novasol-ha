...
class NovaSolStatsCoordinator(DataUpdateCoordinator):
    ...
    async def _async_update_data(self) -> dict:
        ...
        latest_cats = {c["id"]: c["score"] for c in (latest or {}).get("reviewCategories", [])}
        ...
        return {
            ...
            "latest_review_cat_value_for_money":    latest_cats.get("value-for-money"),
            "latest_review_cat_location":           latest_cats.get("location"),
            "latest_review_cat_facilities":         latest_cats.get("facilities"),
            "latest_review_cat_comfort":            latest_cats.get("comfort"),
            "latest_review_cat_cleanliness":        latest_cats.get("cleanliness"),
